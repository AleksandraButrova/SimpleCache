...
#define total_RAM_size			100000												// Kbyte
...
#define total_RAM_entry_number	17//total_RAM_size * 1024 / chunk_size
#define RAM_entry_num			17//RAM_size * 1024 / chunk_size					// the number 
#define prefetch_entry_num		2//prefetch_size * 1024 / chunk_size				// the number 
